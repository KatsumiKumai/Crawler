# Crawler
amazonの商品ページを対象にしたクローラーを作ります

#プログラムの概要
##クローリング
anemoneを使い、起点ページ周辺のページを収集する。このときproductが含まれるURLを収集する。
##評判解析
nokogiriでページのスクレイピングを行う。レビューが多い商品や割引率の高い商品をおススメとして紹介したい。
#参考にした書籍
佐々木拓郎、るびきち(2014)Rubyによるクローラー開発技法 巡回・解析機能の実装と21の運用例
